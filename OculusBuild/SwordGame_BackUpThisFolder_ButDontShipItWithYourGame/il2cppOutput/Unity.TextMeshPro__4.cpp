...
IL_0404:
	...
	{
		TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* L_118 = __this->___m_SoftKeyboard;
		String_t* L_119 = __this->___m_Text;
		NullCheck(L_118);
		TouchScreenKeyboard_set_text_m0A8AA05F4D9D27E8764955F0041452145B6C6FBB(L_118, L_119, NULL);
		VirtualActionInvoker1< BaseEventData_tE03A848325C0AE8E76C6CA15FD86395EBF83364F* >::Invoke(76, __this, (BaseEventData_tE03A848325C0AE8E76C6CA15FD86395EBF83364F*)NULL);
		VirtualActionInvoker1< BaseEventData_tE03A848325C0AE8E76C6CA15FD86395EBF83364F* >::Invoke(37, __this, (BaseEventData_tE03A848325C0AE8E76C6CA15FD86395EBF83364F*)NULL);
		goto IL_05fd;
	}
...
IL_0432:
	...
	{
		bool L_122 = V_29;
		G_B99_0 = ((((int32_t)L_122) == ((int32_t)0))? 1 : 0);
		goto IL_0447;
	}
...
IL_046f:
	{
		...
		V_36 = (bool)((((int32_t)L_128) < ((int32_t)L_130))? 1 : 0);
		bool L_131 = V_36;
		if (L_131)
		{
			goto IL_0358;
	...
	}
	{
		...
		G_B108_0 = ((((int32_t)L_134) > ((int32_t)L_135))? 1 : 0);
		goto IL_04a1;
	}
...
IL_04f8:
	...
	}
	{
		...
		G_B120_0 = ((((int32_t)((((int32_t)L_151) == ((int32_t)((int32_t)31)))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		goto IL_052c;
	}
...
IL_052c:
	...
	{
		int32_t L_153;
		L_153 = TMP_InputField_get_caretSelectPositionInternal_m977002CC2C821A3B4FA5FB3F1BC15C7DD0BA35A4(__this, NULL);
		int32_t L_154;
		L_154 = TMP_InputField_get_caretPositionInternal_m21C9BFCD70C944B374E5C916C7E7E67B75B831EA(__this, NULL);
		int32_t L_155;
		L_155 = Mathf_Min_m888083F74FF5655778F0403BB5E9608BEFDEA8CB_inline(L_153, L_154, NULL);
		V_40 = L_155;
		int32_t L_156;
		L_156 = TMP_InputField_get_caretSelectPositionInternal_m977002CC2C821A3B4FA5FB3F1BC15C7DD0BA35A4(__this, NULL);
		int32_t L_157;
		L_157 = TMP_InputField_get_caretPositionInternal_m21C9BFCD70C944B374E5C916C7E7E67B75B831EA(__this, NULL);
		int32_t L_158;
...
IL_0583:
	...
	}
	{
		...
		G_B128_0 = ((((int32_t)L_168) == ((int32_t)((int32_t)31)))? 1 : 0);
		goto IL_05a4;
	}
...
IL_05b9:
	...
	}
	{
		...
		G_B137_0 = ((!(((uint32_t)L_172) <= ((uint32_t)0)))? 1 : 0);
		goto IL_05d2;
	}
...
IL_05d2:
	...
	}
	{
		...
		V_44 = (bool)((((int32_t)L_175) == ((int32_t)2))? 1 : 0);
		bool L_176 = V_44;
		if (!L_176)
		{
			goto IL_05f4;
